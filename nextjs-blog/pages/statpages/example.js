        ...
        <div className="container">
            ...
            <div className="venerationsList">
                ...
                <ul className="venerationsListHead">
                    <li>
                        <ul className="veneration">
                            <li>Kuo-pao "Shalashaska" Yang</li>
                            <li>RIP Bozo</li>
                        </ul>
                    </li>
                    <li>
                        <ul className="veneration">
                            <li>Patrick "Kazuhira" McDowell</li>
                            <li>lol. lmao.</li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <ul className="veneration">
                            <li>Leo Tolstoy</li>
                            <li>“Well, Prince, so Genoa and Lucca are now just family estates of the Buonapartes. But I warn you, if you don’t tell me that this means war, if you still try to defend the infamies and horrors perpetrated by that Antichrist—I really believe he is Antichrist—I will have nothing more to do with you and you are no longer my friend, no longer my ‘faithful slave,’ as you call yourself! But how do you do? I see I have frightened you—sit down and tell me all the news.”
...
“Attendez,” said Anna Pávlovna, reflecting, “I’ll speak to Lise, young Bolkónski’s wife, this very evening, and perhaps the thing can be arranged. It shall be on your family’s behalf that I’ll start my apprenticeship as old maid.”</li>
                        </ul>
                    </li>                                     
                </ul>
            </div>
