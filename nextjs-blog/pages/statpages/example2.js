...
export default function About(){
    ...
    <div class = "ui equal width middle aligned center aligned grid" style={{ background: '#C1C6E4'}} >
        <div class="ui massive message" style = {{ margin:'2rem'}}>
            <div class="ui medium image">
                <img src="/bioPictures/punishedGDoc.jpg" alt="image placeholder"/>
            </div>
        </div>
      <div class="ui huge message" style = {{ margin:'0 7rem'}}>
        <div class="header">
          Ghassan "Punished" Alkadi
        </div>
        <p><br/>“Well, Prince, so Genoa and Lucca are now just family estates of the Buonapartes. But I warn you, if you don’t tell me that this means war, if you still try to defend the infamies and horrors perpetrated by that Antichrist—I really believe he is Antichrist—I will have nothing more to do with you and you are no longer my friend, no longer my ‘faithful slave,’ as you call yourself! But how do you do? I see I have frightened you—sit down and tell me all the news.”
...
“Attendez,” said Anna Pávlovna, reflecting, “I’ll speak to Lise, young Bolkónski’s wife, this very evening, and perhaps the thing can be arranged. It shall be on your family’s behalf that I’ll start my apprenticeship as old maid.”</p>
      </div>
    </div>
      <style jsx>{`
          .container{
